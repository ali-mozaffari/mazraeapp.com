...
const PestMenuPage = () => {
    ...
    return(
        <div className="page-container container-fluid mb-5">
            ...
            <div>
                <button className='btn-outline-dark-blue d-flex justify-content-between px-3' onClick={() => setOpenFilterModal(true)}>
                    <div>
                        <FilterNewIcon/>
                        <span className='px-2'>
                        فیلتر کردن   
            ...
            <PestSearchInputModal openSearchModal={openSearchModal} setOpenSearchModal={setOpenSearchModal}/>
            <PestFilterModal showModal={openFilterModal} hideModal={setOpenFilterModal}/>
