        ...
        if (pointsState.length > 2) {
            if (farmName.length > 2) {
                ...
                pointsState.forEach(item => {
                    _points = _points ? `${_points},${item['lat']}-${item['lng']}` : `${item['lat']}-${item['lng']}`
                })
            ...
            toast.error('مختصات مزرعه خود را وارد نمایید', {position: 'top-center', theme: 'dark'})
        }
        ...
        <div>
            ...
            <div className="map-tools">
                ...
                <div style={{width: '100px', display: 'flex', flexDirection: 'column-reverse'}}>
                    ...
                    <button className={addPoly ? "btn btn-tools-checked" : "btn btn-tools"}
                ...
                <div className="container-fluid">
                    <div className='row'>
                        ...
                        <div className="col-md-5 mx-auto d-md-block d-flex justify-content-between mt-3 mt-md-0">
                            <button className="btn-farm-add mx-md-2 py-2 py-md-0" onClick={submitHandler}>
                                ذخیره
                            </button>
