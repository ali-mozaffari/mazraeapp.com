...
const Map = () => {
  let area_points = [];
  const mapBoxUrl =
    // "https://api.mapbox.com/styles/v1/mapbox/satellite-streets-v11/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoidGVzdC1tYXoiLCJhIjoiY2trMnd4MHV2MTVjaTJ2cXMxemY1ZXRtZiJ9.FQEAeAkNLH7t2BAYLUBf-g";
              ...
              return (
                <Marker
                  ...
                  eventHandlers={{
                    ...
                    click: (e) => {
                      let filtered_list = pointsState.filter(function (
                        value,
                        index2,
                        arr
                      ) {
