...
function EditNahadeModal({ show, onNahadeModalHandler, values }) {
      ...
      <Modal.Body>
        <Formik
          ...
          validationSchema={Yup.object().shape({
            nahade_item: Yup.string().required("لطفا نهاده خود را انتخاب کنید"),
            meghdar: Yup.string().required(
              "لطفا مقدار نهاده خود را انتخاب کنید"
            ),
            name_nahade: Yup.string().required(
              "لطفا نام و نوع نهاده خود را مشخص کنید"
            ),
            gheimat: Yup.string().required(
              "لطفا قیمت یا هزینه نهاده خود را وارد کنید"
            ),
          })}
        >
          {(props) => {
                ...
                <div className="row">
                  <div className="col-12">
                    <Field
                      ...
                      style={
                        errors.nahade_item && touched.nahade_item
                  ...
                  <div className="col-12">
                    <div className="input-group justify-content-center">
                      <Field
                        ...
                        onBlur={handleBlur}
                        style={
                          errors.meghdar && touched.meghdar
                            ? { border: "1px solid #f00", borderRadius: "15px" }
...
export default EditNahadeModal;
